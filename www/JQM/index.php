	...
	<div id="recherche" data-role="page" data-add-back-btn="true">
		...
		<section>
			...
			<form method="get" class="form" action="index.php" name="rech">
				...
				<labelfor="prix">Prix </label><input type="text" name="prix"><br> 
				<label for="disponibilite">Disponibilit&eacute; </label><input type="text" name="disponibilite"><br> <br class="clear" /> 
			</form>
		</section>
		<footer data-position="fixed">
			<nav data-role="navbar">			
